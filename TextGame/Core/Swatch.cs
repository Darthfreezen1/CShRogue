...
namespace TextGame.Core{
    /// <summary>
    /// Colors STOLEN!!!! from https://roguesharp.wordpress.com/2016/03/05/roguesharp-v3-tutorial-color-palette/
    /// 
    /// This class defines the color swatch used
    /// 
    /// EG if i wanted to color an @ differently than the player @ i could use an alternate color on the swatch
    /// 
    /// </summary>
    public class Swatch {
